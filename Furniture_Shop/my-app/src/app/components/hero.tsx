    ...
    <div className={`max-w-[1440px] mx-auto w-[100%] ${poppins.className} `} >
      ...
      <div className="bg-white w-[90%] mx-auto h-fit lg:h-auto pt-9 pb-16 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10 mt-12">
          {/* Blog Card 1 */}
          <div className={`text-center ${poppins.className} bg-gray-100 p-5 rounded-lg shadow-md cursor-pointer group`}>
            <Image className="w-full rounded-md h-[280px] object-cover cursor-pointer  transition-transform duration-200  group-hover:scale-105 " src="/images/keyboard.jpeg" alt="Keyboard Blog" width={393} height={280} />
          ...
          {/* Blog Card 2 */}
          <div className={`text-center ${poppins.className} bg-gray-100 p-5 rounded-lg shadow-md cursor-pointer group `}>
            <Image className="w-full rounded-md h-[280px] object-cover transition-transform duration-200 group-hover:scale-105 " src="/images/bloglaptop.jpeg" alt="Laptop Blog" width={393} height={280} />
          ...
          {/* Blog Card 3 */}
          <div className={`text-center ${poppins.className} bg-gray-100 p-5 rounded-lg shadow-md cursor-pointer group`}>
            <Image className="w-full rounded-md h-[280px] object-cover transition-transform duration-200 group-hover:scale-105 " src="/images/blog2lap2.jpeg" alt="Our Blog" width={393} height={280} />
        ...
        {/* View All Button */}
        <div className="w-[160px] mx-auto mt-14">
          <button className={`text-[18px] font-semibold text-blue-600 hover:text-blue-700 transition-all ${poppins.className}`}>
            View All Posts
          </button>
          <hr className="w-[80%] mx-auto border-gray-400 mt-1" />
        </div>
